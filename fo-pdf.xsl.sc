...
<xsl:stylesheet version="1.0"
    ...
    <xsl:attribute-set name="header.content.properties">
        <xsl:attribute name="font-family">Noto Sans CJK SC,Sans-serif,Arial</xsl:attribute>
    ...
    <xsl:template name="pickfont-sans">
        <xsl:text>Noto Sans CJK SC,Sans-serif,Arial,Arial Unicode MS,Helvetica,serif,Georgia,Times New Roman</xsl:text>
    </xsl:template>

    <xsl:template name="pickfont-serif">
        <xsl:text>Noto Serif CJK SC,Sans-serif,Arial,Arial Unicode MS,Helvetica,serif,Georgia,Times New Roman</xsl:text>
    </xsl:template>

    <xsl:template name="pickfont-mono">
        <xsl:text>Noto Sans Mono CJK SC,Liberation Mono,Lucida Console,Monaco,Consolas,Courier New,Courier,monospace,Arial Unicode MS,Lucida Sans Unicode</xsl:text>
    </xsl:template>
    ...
    <xsl:template name="pickfont-symbol">
        <xsl:text>Symbol,ZapfDingbats,Noto Sans CJK SC</xsl:text>
    </xsl:template>
